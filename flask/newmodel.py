...
def get_collaborative_recommendations(user_id, interaction_matrix, model, n=7):
...
def get_health_based_recommendations(user_id, users, products, n=5):
    if user_id not in users["userid"].values:
        return []
...
def get_recommendations(user_id):
    ...
    recommended_ids = get_hybrid_recommendations(user_id, users, products, events, model, interaction_matrix, n=8)
